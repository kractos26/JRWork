...
namespace JWork.UI.Administracion.Business
{
    public class TipoIdentificacionBL
    {
        ...
        public async Task<Response<List<TipoIdentificacionDto>>> GetTodo() => await _service.BuscarTodoAsync();
        public async Task<Response<TipoIdentificacionDto>> GetPorId(int id) => await _service.BuscarPorIdAsync(id);
