...
namespace JWork.UI.Administracion.Business
{
    public class TipoPersonaBL
    {
        ...
        public async Task<Response<List<TipoPersonaDto>>> GetTodo() => await _service.BuscarTodoAsync();
        public async Task<Response<TipoPersonaDto>> GetPorId(int id) => await _service.BuscarPorIdAsync(id);
