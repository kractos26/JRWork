...
namespace JWork.UI.Administracion.Business
{
    public class TipoDocumentoBL
    {
        ...
        public async Task<Response<List<TipoDocumentoDto>>> GetTodoAsync() => await _service.BuscarTodoAsync();
        public async Task<Response<TipoDocumentoDto>> GetPorIdAsync(int id) => await _service.BuscarPorIdAsync(id);
