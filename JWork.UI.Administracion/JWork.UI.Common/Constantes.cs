namespace JWork.UI.Administracion.Common
{
    public class Constantes
    {
        ...
        public static class UrlActividad
        {
            public static string Post => "api/Actividad/Crear";
        ...
        public static class ConceptoCalificacion
        {
            public static string Post => "api/ConceptoCalificacion/Crear";
        ...
        {
            public static string Post => "api/Divipola/Crear";
        ...
        {
            public static string Post => "api/Oficio/Crear";
        ...
        {
            public static string Post => "api/TipoDocumento/Crear";
        ...
        {
            public static string Post => "api/TipoIdentificacion/Crear";
        ...
        {
            public static string Post => "api/TipoPersona/Crear";
        ...
        {
            public static string Post => "api/UnidadMedida/Crear";
        ...
        {
            public static string Post => "api/Habilidad/Crear";
