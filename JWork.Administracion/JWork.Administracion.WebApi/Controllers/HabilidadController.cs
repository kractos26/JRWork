...
namespace JWork.Administracion.WebApi.Controllers
{
    ...
    public class HabilidadController : ControllerBase
    {
        ...
        public async Task<ActionResult<Response<List<HabilidadDto>>>> BuscarPaginado([FromQuery] Buscar.HabilidadBuscarPaginadoCommand command)
        {
            try
            {
                List<HabilidadDto> actividadDtos = await _mediator.Send(command);

                var response = new Response<List<HabilidadDto>>
                {
